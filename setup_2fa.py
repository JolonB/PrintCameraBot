...
if __name__ == "__main__":
    ...
    print("If you don't have an authenticator app, you can use Google" \
            " Authenticator or Authy.")
    print("Make sure you copy this code into your config.py file in the"
            " \"approved_users\" section too.")

    print("\n\n")

    code = input("Please enter your two-factor authentication code generated by"
